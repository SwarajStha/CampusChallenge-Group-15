...
├── README.md
│
├── data/                             ← Main data directory (empty/gitignored)
│
...
3. Run daily workflow (steps 1-4 above) or monthly workflow (steps 1-5 above)
4. Analyze results from statistics CSV files and plots